			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <h5 class="text-muted font-weight-normal mb-4">Criar uma conta gratuita.</h5>
                    <form class="forms-sample">
                      ...
                      <div class="mt-3">
                        <button type="submit" class="btn btn-primary mr-2 mb-2 mb-md-0">Inscrever-se</button>
                        <!-- <button type="button" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">
                          <i class="btn-icon-prepend" data-feather="twitter"></i>
                          Sign up with twitter
                        </button> -->
                      </div>
                      <a href="login.html" class="d-block mt-3 text-muted">Já é usuário? Assinar em</a>
                    </form>
                  </div>
                </div>
              </div>
